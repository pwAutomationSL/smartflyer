...
export class Partners {
  ...
  public async destinationsCoverage() {
    await this.page
      .getByRole("checkbox", { name: "Caribbean & Mexico" })
      .check();
    ...
    await this.page
      .getByRole("checkbox", { name: "Australia & New Zealand" })
      .check();
  }
  ...
  public async fillSmartFlyerAmenities() {
    ...
    await this.page
      .getByRole("textbox", { name: "Enter SmartFlyer Elevate" })
      .fill("Sauna");
  }
  ...
  public async fillPreferredPartnerProgramAmenities() {
    await this.page
      .locator("#have_preferred_partner_program_yes")
      .dispatchEvent("click");
  ...
  public async fillAdditionalContacts() {
    await this.page
      .getByRole("textbox", { name: "Enter POSITION / TITLE" })
      .fill("Additional");
  ...
  public async fillIndustryAffiliationTTK() {
    ...
    await this.page
      .getByRole("checkbox", { name: "Leading Hotels of the World" })
      .check();
    await this.page
      .getByRole("radio", { name: "Yes NO Overview Lock" })
      .check();
  }
  ...
  public async fillKeySellingPointsTTK() {
    await this.page
      .locator(
        'input[name="things_to_know[brand_name_of_representitive_company]"]'
      )
      .fill("Test Company");
    await this.page
  ...
  public async checkCommissionsOffering() {
    ...
    for (const i of percentages) {
      await this.page
        .locator(`//input[@id="commisiion_offer_percent_${i}"]`)
        .check();
    }
    await this.page
      .locator('[name="commission_detail"]')
      .fill("5% on test, 10% on test 2");
  }
  ...
  public async latestUpdatesMarketing() {
    ...
    await this.page
      .locator(
        'textarea[name="offers_and_training[latest_updates][0][description]"]'
      )
  ...
  public async articlesMKT() {
    await this.page
      .getByRole("textbox", { name: "Enter article title" })
      .fill("Test Title");
    await this.page
    ...
    await this.page
      ...
      .fill("www.test.com");
    await this.page
      .getByRole("button", { name: "Add More", exact: true })
      .click();
    await this.page
      .locator('input[name="marketing[article][3][title]"]')
      .fill("Test 2");
  ...
  public async marketingMKT() {
    await this.page
      .getByRole("textbox", { name: "Enter Brand Username" })
      .fill("@test");
  ...
  public async socialMediaStoryMKT() {
    ...
    await this.page
      .getByRole("textbox", { name: "insert property name and" })
      .fill("Q3 Test");
  }
