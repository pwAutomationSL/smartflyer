...
export class PartnersHotel {
  ...
  public async fillAdditionalContact() {
    ...
    await this.page
      .locator(
        `input[name="contacts[${FIELD_PATH}][0][include_smartflyer_emails][0]"]`
      )
      .check();
  }
  ...
  public async accommodationsMainTitle() {
    await this.page
      .getByRole("textbox", { name: "Room title" })
      .fill("Room title test");
  }
  ...
  public async accommodationsPool() {
    ...
    await this.page
      .locator('input[name="overview[pool_and_gym][title]"]')
      .fill("Main Title pool");
    await this.page
      .getByRole("button", { name: "Choose From Gallery" })
      .nth(2)
      .click();
  ...
  public async accommodationsGym() {
    ...
    await this.page
      .locator('input[name="overview[gym][title]"]')
      .fill("Main Title gym");
    await this.page
      .getByRole("button", { name: "Choose From Gallery" })
      .nth(3)
  ...
  public async accommodationsSpa() {
    ...
    await this.page
      .locator('input[name="overview[spa][title]"]')
      .fill("Main Title spa");
    await this.page
      .getByRole("button", { name: "Choose From Gallery" })
      .nth(4)
  ...
  public async accommodationsBar() {
    ...
    await this.page
      .locator('input[name="overview[bar][title]"]')
      .fill("Main Title bar");
    await this.page
      .getByRole("button", { name: "Choose From Gallery" })
      .nth(6)
    ...
    await this.selectPhoto();
    await this.page
      .getByRole("textbox", { name: "What’s the bar like?" })
      .fill("restaurant test");
  }
  ...
  public async groupBookings() {
    ...
    await this.page
      .getByRole("textbox", { name: "Enter contact Details" })
      .fill("Contact Test");
    await this.page
  ...
  public async additionalDetails() {
    ...
    await this.page
      .locator('textarea[name="things_to_know[peak_season]"]')
      .fill("Winter");
  }
  public async checkCommissionsOfferingHotel() {
    await this.page
      ...
      .fill("Condition Test");
    await this.page
      .locator('input[name="commission[agreement_validity_date]"]')
      .fill("2025-11-13");
  }
  public async bestWayToBook() {
    ...
    await this.page
      .getByRole("textbox", { name: "Enter answer..." })
      .fill("Best way to book");
    await this.page
      .getByRole("checkbox", { name: "Dedicated SmartFlyer Booking" })
      .check();
    await this.page
  ...
  public async advisorFeedback() {
    await this.page
      .getByRole("textbox", { name: "select travel advisor" })
      .click();
    await this.page
  ...
  public async training() {
    ...
    await this.page
      .getByRole("treeitem", { name: "General Development" })
      .click();
    await this.page
  ...
  public async offersAndPromotions() {
    ...
    await this.page
      .locator(
        'input[name="offers_and_training[offers_and_promotion][0][start_date]"]'
      )
      .fill("2025-11-21");
    await this.page
      .locator(
        'input[name="offers_and_training[offers_and_promotion][0][expire_date]"]'
      )
      .fill("2025-11-21");
    await this.page
      .locator(
        'textarea[name="offers_and_training[offers_and_promotion][0][description]"]'
      )
      .click();
    await this.page
      .locator(
  ...
  public async peakAvailabilities() {
    await this.page
      .locator('input[name="availability[0][title]"]')
      .fill("Availability test");
    await this.page
      .locator('input[name="availability[0][start_date]"]')
      .fill("2025-11-13");
    await this.page
      .locator('input[name="availability[0][expire_date]"]')
      .fill("2025-11-13");
    await this.page
  ...
  public async propertyUpdates() {
    ...
    await this.page
      .locator(
        'textarea[name="offers_and_training[property_updates][0][description]"]'
      )
      .fill("description test");
    await this.page
  ...
  public async societySetting() {
    ...
    await this.page
      .getByRole("checkbox", { name: "Approve", exact: true })
      .check();
    await this.page.getByRole("checkbox", { name: "Featured Leisure" }).check();
    await this.page
      .locator('input[name="overview[member_since]"]')
      .fill("2025-11-11");
  }
  public async socialMediaStoryHotelMKT() {
    await this.page
      .getByRole("textbox", { name: "Story Name" })
      .fill("Story test");
    await this.page
      .getByRole("textbox", { name: "Story link" })
      .fill("www.test.com");
    await this.page
    ...
    await this.selectPhoto();
    await this.page
      .getByRole("textbox", { name: "Enter hashtag" })
      .fill("#Test");
  }
}
