...
const PARTNER_USERNAME = {
  username: 'oksana.gorodiska+4@scrumlaunch.com',
  password: 'sf_partner_01@',
};
test.setTimeout(200000);
test.describe('SFC-387 Partner', () => {
  test('As an Partner user i can not see draft, and can seepublished partners without Status Column- Brand', async ({
    loginPage,
    page,
    sidebar,
    partners,
    ...
    await test.step('1 - Log in to Society ', async () => {
      await loginPage.login(PARTNER_USERNAME);
  ...
  test('As an Partner user i can not see draft, and can see published partners -Global Search- Brand', async ({
    loginPage,
    page,
    sidebar,
    searchPage,
  ...
  test('As an Partner user i can not see draft, and can seepublished partners without Status Column- Hotel', async ({
    loginPage,
    page,
    sidebar,
    partners,
  ...
  test('As an Partner user i can not see draft, and can see published partners -Global Search- Hotel', async ({
    loginPage,
    page,
    sidebar,
    searchPage,
  ...
  test('As an Partner user i can not see draft, and can seepublished partners without Status Column- Onsite', async ({
    loginPage,
    page,
    sidebar,
    partners,
  ...
  test('As an Partner user i can not see draft, and can see published partners -Global Search- Onsite', async ({
    loginPage,
    page,
    sidebar,
    searchPage,
